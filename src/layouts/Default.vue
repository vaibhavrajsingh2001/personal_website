<template>
	<div
		class="content-wrapper font-sans text-copy-primary leading-normal flex flex-col min-h-screen overflow-x-hidden"
		:class="theme"
	>
			...
			>
				<div>
					<g-link v-if="theme === 'theme-light'" to="/"
						><g-image src="/logo.png" class="w-20" alt="logo"
					/></g-link>
					<g-link v-else to="/"
						><g-image src="/logo.png" class="w-20" alt="logo"
					/></g-link>
		...
		<footer class="bg-green-700 text-white">
			<div
				class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-4"
			>
				<div class="mb-8 lg:mb-0">
					<div>
						© VRS {{ new Date().getFullYear() }}. All rights
						reserved.
					</div>
					<div>
						<a
				...
				<ul class="flex items-center space-x-8">
					...
					<li>
						<a
							...
							href="https://github.com/vaibhavrajsingh2001/"
							rel="noreferrer"
							target="_blank"
							class="text-white hover:text-gray-400"
						>
					...
					<li>
						<a
							...
							href="https://twitter.com/vrs2001"
							rel="noreferrer"
							target="_blank"
							class="text-white hover:text-gray-400"
						>
					...
					<li>
						<a
							...
							href="https://instagram.com/vaibhavrajsingh2001"
							rel="noreferrer"
							target="_blank"
							class="text-white hover:text-gray-400"
						>
